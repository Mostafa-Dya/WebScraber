...
- `enquiryLinks(name, id)` → `{ whatsapp, mailto, askPhotos }`:
  `https://wa.me/16475615157?text=` + `encodeURIComponent("Hi Serio Ludere, I am interested in " + name + " (ref " + id + ").")`;
...
| 5   | `src/lib/studio.ts` (new)                                             | `STUDIO_WHATSAPP = '16475615157'`, `STUDIO_EMAIL = 'hello@serioludere.com'`; `Footer.astro` reads them                                                                                                                                                                                                                                                                                                                                                                       | —                                                                                                         | P1                                  |
